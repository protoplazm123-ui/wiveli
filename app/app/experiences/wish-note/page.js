  ...
  return (
    <main className="productPage">
      ...
      <section className="productHero">
        <div className="productHeroCopy">
          ...
          <div className="productActions">
            ...
            <a href="#how-it-works" className="secondary productSecondary">
              How It Works
            </a>
          </div>
        ...
        <div className="demoCopy">
          ...
          <div className="wishCategories">
            <div>
              ...
              <p>Little plans and things you want to experience together.</p>
            </div>

            <div>
              <span>02</span>
              <strong>Food Dreams</strong>
              <p>Restaurants, dishes and spontaneous food adventures.</p>
            </div>

            <div>
              <span>03</span>
              <strong>Our Time</strong>
              <p>Dates, activities and ways to spend your time together.</p>
            </div>

            <div>
              <span>04</span>
              <strong>Honest Talk</strong>
              <p>A safe little space for things that need to be said.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="productCTA">
        ...
        <button className="primary">Personalize Wish Note →</button>
      </section>
